...
namespace twitterClasses
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            h2.Print();
            Tweet tw1 = new Tweet(h1, "Оппозиционный политик и главный оппонент действующего главы государства Сооронбая Жээнбекова на последних президентских выборах Омурбек Бабанов вернулся в Киргизию");
